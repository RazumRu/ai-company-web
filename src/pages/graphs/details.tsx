...
export const GraphPage = () => {
  ...
  const handleTriggerClick = useCallback(
    (nodeId: string) => {
      // Find the node and open the trigger modal directly
  ...
  const handleTrigger = useCallback(
    async (triggerMessage: string, threadSubId?: string) => {
      ...
      try {
        ...
        const executeTriggerDto: ExecuteTriggerDto = {
          ...
          threadSubId: threadSubId, // Use the threadSubId from the modal
        };
        ...
        const errorMessage = error instanceof Error ? error.message : 'Failed to trigger node';
