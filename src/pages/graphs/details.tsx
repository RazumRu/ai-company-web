...
import { createEdge, resolveHandlesForNodes } from './utils/graphCanvasUtils';
...
const normalizeGraphDiffSnapshot = (state: GraphDiffState) => {
  return {
...
export const GraphPage = () => {
  ...
  return (
    <Layout style={{ overflow: 'hidden' }}>
      ...
      <Modal
        open={localDiffModalVisible}
        onCancel={handleCloseLocalDiff}
        footer={null}
        title={
          graph?.version
            ? `Local changes diff (v${graph.version})`
            : 'Local changes diff'
        }
        width={720}
        destroyOnClose>
        {localDiffPatch ? (
          <div style={{ maxHeight: '60vh', overflow: 'auto' }}>
            <DiffHtmlView diff={localDiffPatch} />
          </div>
        ) : (
