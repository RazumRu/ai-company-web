...
export const GraphPage = () => {
    ...
    (async () => {
      try {
        ...
        if (savedState) {
          ...
          nodesRef.current = savedState.nodes;
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const errorMessage =
        e.response?.data?.message || e.message || 'Failed to save graph';
  ...
  const handleNameSave = async () => {
    ...
    try {
      ...
      const errorMessage =
        e.response?.data?.message || e.message || 'Failed to update graph name';
      message.error(errorMessage);
    ...
    <Layout style={{ overflow: 'hidden' }}>
      ...
      <Layout style={{ height: 'calc(100vh - 173px)', overflow: 'hidden' }}>
        <Sider
          ...
          <TemplateSidebar onTemplateClick={handleTemplateClick} />
        </Sider>
      ...
      <NodeEditModal
        ...
        onClose={() => setNodeEditModalVisible(false)}
        onSave={handleNodeSave}
      />
    </Layout>
  );
