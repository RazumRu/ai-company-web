...
interface NodeEditSidebarProps {
  ...
  // Trigger modal props
  triggerModalVisible?: boolean;
  onTriggerModalCancel?: () => void;
        ...
        Object.entries(values).forEach(([key, value]) => {
          ...
          if (!field?.isConst) {
            ...
            if (field?.type === 'number' && typeof value === 'string') {
              ...
              // Handle array input (one per line)
    ...
    <Sider
      ...
      <div
        ...
        <div
          ...
          <Space>
            {/* Trigger Button - only for trigger nodes */}
            {isTriggerNode && (
              <Button
                type="primary"
                icon={<PlayCircleOutlined />}
                disabled={!canTrigger}
                onClick={() => onTriggerClick?.(node.id)}
                size="small">
                Trigger
              </Button>
            )}
      ...
      <TriggerModal
        ...
        onCancel={onTriggerModalCancel || (() => {})}
        onTrigger={onTrigger || (async () => {})}
        nodeId={node?.id}
