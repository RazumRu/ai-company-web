...
export const ChatsPage = () => {
  ...
  const loadThreads = useCallback(
    async (options?: { append?: boolean }) => {
      ...
      try {
        ...
        setThreads((prev) => {
          if (!isAppend) {
            return sortThreadsByTimestampDesc(fetched);
          }
  ...
  const handleThreadCreateEvent = useCallback(
    ...
    [ensureGraphsLoaded, setExternalThreadIds, sortThreadsByTimestampDesc],
  );
  ...
  const handleThreadUpdateEvent = useCallback(
    ...
    [setExternalThreadIds, shouldApplyThreadUpdate, sortThreadsByTimestampDesc],
  );
