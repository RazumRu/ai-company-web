# ThreadUsageStatisticsDtoMessagesAggregate
...
```typescript
import { ThreadUsageStatisticsDtoMessagesAggregate } from './api';

const instance: ThreadUsageStatisticsDtoMessagesAggregate = {
  inputTokens,
  cachedInputTokens,
  outputTokens,
  reasoningTokens,
