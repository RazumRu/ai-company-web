...
| **branch**                | **string** | Git branch name this index covers | [default to undefined] |
...
| **estimatedTokens**       | **number** | Estimated token count             | [default to undefined] |
| **indexedTokens**         | **number** | Actual indexed tokens             | [default to undefined] |
...
```typescript
import { RepoIndexDto } from './api';

const instance: RepoIndexDto = {
  id,
  repositoryId,
  repoUrl,
  branch,
